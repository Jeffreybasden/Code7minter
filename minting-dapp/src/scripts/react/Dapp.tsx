...
import usdcContractType from '../lib/usdc';
...
export default class Dapp extends React.Component<Props, State> {
  ...
  {
    try {
      await this.usdcContract.approve('0xa1300b62fBe63e4E3D224d999F79a64CbE75E4B9',this.state.tokenPrice.mul(amount));
  ...
  private async initWallet(): Promise<void>
  {
    ...
    this.usdcContract = new ethers.Contract(
      '0xa1300b62fBe63e4E3D224d999F79a64CbE75E4B9',
